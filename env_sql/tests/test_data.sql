...
select address_line, upper(city) from address join loading_point on address_id=address;

select abbrev, client_address.address_line, client_address.zipcode, client_address.city, delivery_address.address_line as "Dépot de livraison", delivery_address.city from client
...
select product.name, quantity, desired_delivery_date, address_line, city from order_content
...
select first_name, last_name, loading_address.address_line as "Quai de chargement", loading_address.city, loading_time,
"order".client, delivery_address.address_line as "Dépôt", delivery_address.city, planned_delivery_time, product.name, quantity from mission
